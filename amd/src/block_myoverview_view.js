...
import $ from 'jquery';
import * as Repository from 'theme_urcourses/block_myoverview_repository';
...
import SELECTORS from 'theme_urcourses/block_myoverview_selectors';
...
const TEMPLATES = {
    COURSES_CARDS: 'theme_urcourses/block_myoverview/view-cards',
    COURSES_LIST: 'theme_urcourses/block_myoverview/view-list',
    COURSES_SUMMARY: 'theme_urcourses/block_myoverview/view-summary',
    NOCOURSES: 'core_course/no-courses',
    SUMMARYMODAL: 'theme_urcourses/block_myoverview/course-summary-modal-body'
};
